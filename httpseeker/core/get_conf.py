...
from httpseeker.common.errors import ConfigInitError
from httpseeker.common.toml_handler import read_toml

__all__ = ['httpseeker_config']
...
def cache_httpseeker_config() -> HttpSeekerConfig:
    return HttpSeekerConfig()


httpseeker_config = cache_httpseeker_config()
