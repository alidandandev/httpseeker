...
__all__ = ['httpseeker_path']


class HttpSeekerPathConfig:
    @property
...
def cache_httpseeker_path() -> HttpSeekerPathConfig:
    return HttpSeekerPathConfig()


httpseeker_path = cache_httpseeker_path()
