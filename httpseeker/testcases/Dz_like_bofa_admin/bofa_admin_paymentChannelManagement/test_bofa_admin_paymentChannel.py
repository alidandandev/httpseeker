...
ddt_data, ids = get_testcase_data(filename='test_bofa_admin_paymentChannel.yaml')


class TestBofaAdminPaymentchannel:
    """BofaAdminPaymentchannel"""

    @pytest.mark.parametrize('case_data', ddt_data, ids=ids)
    def test_bofa_admin_paymentChannel(self, case_data):
        """test_bofa_admin_paymentChannel"""
