...
ddt_data, ids = get_testcase_data(filename='test_bofa_admin_bankCard .yaml')


class TestBofaAdminBankcard :
    """BofaAdminBankcard """

    @pytest.mark.parametrize('case_data', ddt_data, ids=ids)
    def test_bofa_admin_bankCard (self, case_data):
        """test_bofa_admin_bankCard """
