...
ddt_data, ids = get_testcase_data(filename='test_bofa_admin_signInScoreSet.yaml')


class TestBofaAdminSigninscoreset:
    """BofaAdminSigninscoreset"""

    @pytest.mark.parametrize('case_data', ddt_data, ids=ids)
    def test_bofa_admin_signInScoreSet(self, case_data):
        """test_bofa_admin_signInScoreSet"""
