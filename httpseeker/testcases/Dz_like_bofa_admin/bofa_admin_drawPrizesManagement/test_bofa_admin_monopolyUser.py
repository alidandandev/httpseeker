...
ddt_data, ids = get_testcase_data(filename='test_bofa_admin_monopolyUser.yaml')


class TestBofaAdminMonopolyuser:
    """BofaAdminMonopolyuser"""

    @pytest.mark.parametrize('case_data', ddt_data, ids=ids)
    def test_bofa_admin_monopolyUser(self, case_data):
        """test_bofa_admin_monopolyUser"""
