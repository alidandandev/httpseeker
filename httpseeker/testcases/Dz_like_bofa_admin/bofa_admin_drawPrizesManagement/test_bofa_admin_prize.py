...
ddt_data, ids = get_testcase_data(filename='test_bofa_admin_prize.yaml')


class TestBofaAdminPrize:
    """BofaAdminPrize"""

    @pytest.mark.parametrize('case_data', ddt_data, ids=ids)
    def test_bofa_admin_prize(self, case_data):
        """test_bofa_admin_prize"""
