...
ddt_data, ids = get_testcase_data(filename='test_bofa_admin_creditRecord.yaml')


class TestBofaAdminCreditrecord:
    """BofaAdminCreditrecord"""

    @pytest.mark.parametrize('case_data', ddt_data, ids=ids)
    def test_bofa_admin_creditRecord(self, case_data):
        """test_bofa_admin_creditRecord"""
