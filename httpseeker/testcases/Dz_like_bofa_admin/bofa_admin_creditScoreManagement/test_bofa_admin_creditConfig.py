...
ddt_data, ids = get_testcase_data(filename='test_bofa_admin_creditConfig.yaml')


class TestBofaAdminCreditconfig:
    """BofaAdminCreditconfig"""

    @pytest.mark.parametrize('case_data', ddt_data, ids=ids)
    def test_bofa_admin_creditConfig(self, case_data):
        """test_bofa_admin_creditConfig"""
