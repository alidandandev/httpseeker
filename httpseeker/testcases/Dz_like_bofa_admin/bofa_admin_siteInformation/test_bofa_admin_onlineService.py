...
ddt_data, ids = get_testcase_data(filename='test_bofa_admin_onlineService.yaml')


class TestBofaAdminOnlineservice:
    """BofaAdminOnlineservice"""

    @pytest.mark.parametrize('case_data', ddt_data, ids=ids)
    def test_bofa_admin_onlineService(self, case_data):
        """test_bofa_admin_onlineService"""
