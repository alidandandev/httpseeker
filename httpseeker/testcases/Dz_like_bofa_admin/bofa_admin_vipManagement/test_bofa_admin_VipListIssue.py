...
ddt_data, ids = get_testcase_data(filename='test_bofa_admin_VipListIssue.yaml')


class TestBofaAdminViplistissue:
    """BofaAdminViplistissue"""

    @pytest.mark.parametrize('case_data', ddt_data, ids=ids)
    def test_bofa_admin_VipListIssue(self, case_data):
        """test_bofa_admin_VipListIssue"""
