        ...
        try:
            ...
            if len(tag_case) > 0:
                for k, v in tag_case.items():
                    ...
                    write_yaml(
                        ...
                        os.sep.join(
                            [project or httpseeker_config.PROJECT_NAME, k, get_file_property(source)[1] + '.yaml']
                        ),
                        case_file_data,
                        mode='w',
                    )
            ...
            if len(root_case) > 0:
                for v in root_case.values():
                    ...
                    write_yaml(
                        httpseeker_path.case_data_dir,
                        os.sep.join([project or httpseeker_config.PROJECT_NAME, get_file_property(source)[1] + '.yaml']),
                        case_file_data,
                        mode='w',
                    )
